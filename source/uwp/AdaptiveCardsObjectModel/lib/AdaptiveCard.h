...
namespace AdaptiveCards::ObjectModel::Uwp
{
    ...
    public:
        ...
        IFACEMETHODIMP get_BackgroundImage(_Outptr_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveBackgroundImage** backgroundImage);
        IFACEMETHODIMP put_BackgroundImage(_In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveBackgroundImage* backgroundImage);
        ...
        IFACEMETHODIMP get_VerticalContentAlignment(_Out_ ABI::AdaptiveCards::ObjectModel::Uwp::VerticalContentAlignment* verticalAlignment);
        IFACEMETHODIMP put_VerticalContentAlignment(ABI::AdaptiveCards::ObjectModel::Uwp::VerticalContentAlignment verticalAlignment);

        IFACEMETHODIMP get_Body(
            _COM_Outptr_ ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCardElement*>** body);

        IFACEMETHODIMP get_Actions(
            _COM_Outptr_ ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveActionElement*>** actions);

        IFACEMETHODIMP get_ElementType(_Out_ ABI::AdaptiveCards::ObjectModel::Uwp::ElementType* elementType);

        IFACEMETHODIMP get_Height(_Out_ ABI::AdaptiveCards::ObjectModel::Uwp::HeightType* heightType);
        IFACEMETHODIMP put_Height(ABI::AdaptiveCards::ObjectModel::Uwp::HeightType heightType);

        IFACEMETHODIMP get_MinHeight(_Out_ UINT32* minHeight);
        IFACEMETHODIMP put_MinHeight(UINT32 minHeight);

        IFACEMETHODIMP get_Refresh(_COM_Outptr_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveRefresh** refresh);
        IFACEMETHODIMP put_Refresh(_In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveRefresh* refresh);

        IFACEMETHODIMP get_Authentication(_COM_Outptr_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveAuthentication** authentication);
        IFACEMETHODIMP put_Authentication(_In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveAuthentication* authentication);

        IFACEMETHODIMP ToJson(_COM_Outptr_ ABI::Windows::Data::Json::IJsonObject** result);

        IFACEMETHODIMP GetResourceInformation(
            _COM_Outptr_ ABI::Windows::Foundation::Collections::IVectorView<ABI::AdaptiveCards::ObjectModel::Uwp::AdaptiveRemoteResourceInformation*>** uris);
