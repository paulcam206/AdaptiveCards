...
namespace AdaptiveCards::ObjectModel::Uwp
{
    ...
    public:
        ...
        IFACEMETHODIMP get_Actions(
            _COM_Outptr_ ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveActionElement*>** items);
        ...
        IFACEMETHODIMP put_Height(_In_ ABI::AdaptiveCards::ObjectModel::Uwp::HeightType height)
        {
