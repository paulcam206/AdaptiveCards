...
namespace AdaptiveCards::ObjectModel::Uwp
{
    ...
    public:
        ...
        IFACEMETHODIMP get_TextInputStyle(_Out_ ABI::AdaptiveCards::ObjectModel::Uwp::TextInputStyle* textInputStyle);
        IFACEMETHODIMP put_TextInputStyle(ABI::AdaptiveCards::ObjectModel::Uwp::TextInputStyle textInputStyle);

        IFACEMETHODIMP get_InlineAction(_COM_Outptr_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveActionElement** action);
        IFACEMETHODIMP put_InlineAction(_In_ ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveActionElement* action);
