...
namespace AdaptiveCards::ObjectModel::Uwp
{
    ...
    public:
        ...
        IFACEMETHODIMP get_Items(
            _COM_Outptr_ ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveCards::ObjectModel::Uwp::IAdaptiveCardElement*>** items);
        ...
        IFACEMETHODIMP get_BleedDirection(_Out_ ABI::AdaptiveCards::ObjectModel::Uwp::BleedDirection* bleedDirection);
